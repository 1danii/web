...
function ImagePreview({
  ...
  return (
    <button
      ...
      className="bg-background-elevated border-border-transparent relative aspect-video size-full cursor-zoom-in overflow-hidden rounded-lg border bg-clip-padding not-dark:shadow-xs"
    >
      {type === "image" ? (
