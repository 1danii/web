...
function ImagePreview({
  ...
  return (
    <button
      ...
      className="outline-border-transparent relative aspect-video size-full cursor-zoom-in overflow-hidden rounded-lg outline -outline-offset-1 not-dark:shadow-xs"
    >
      {type === "image" ? (
